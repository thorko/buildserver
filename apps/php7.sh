...
wget %url -O /tmp/php7.tar.bz2

cd %build_path
tar -xjvf /tmp/php7.tar.bz2
cd php-%version
...
sed -i '/^LoadModule php7_module/d' /etc/apache2/httpd.conf

cp libs/libphp7.so /usr/local/php7/%version/lib
